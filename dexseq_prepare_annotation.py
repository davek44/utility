...
optParser.add_option( "-u", "--unstrand", dest="unstrand",
   default = False, action='store_true',
   help = "Indicates whether to ignore gene strand, which removes all overlapping exon fragments.")
...
exons = HTSeq.GenomicArrayOfSets( "auto", stranded=(not opts.unstrand)) # True )
